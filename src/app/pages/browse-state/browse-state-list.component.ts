...
@Component({
  selector: 'app-browse-state-list',
  templateUrl: './browse-state-list.component.html',
  styleUrls: ['./browse-state-list.component.css']
})
export class BrowseStateListComponent implements OnChanges {
